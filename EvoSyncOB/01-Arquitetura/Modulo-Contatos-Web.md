---
tipo: doc
tags: [evosync, arquitetura, contatos, web]
criado: 2026-06-14
status: ativo
origem: evosync-web/docs/contacts-organization.md
---
...
> **Nota do vault:** esta é a especificação detalhada do [[ADR-001-Contatos-Organizados]]
> (versão resumida que vive na pasta `Decisoes/`).
...
- [[ADR-001-Contatos-Organizados]] — versão resumida na pasta Decisoes
- [[ADR-004-Modelo-SaaS-Hospedado]] — modelo de hospedagem (você hospeda por tenant)
- [[MOC-SaaS-Web]] — onde tudo isso vive no código
- [[Visao-Geral]] — visão macro da arquitetura
- [[Seguranca]] — implicações de segurança (opt-out = LGPD)
- [[Guia-Cliente-Primeiros-Passos]] — como o cliente B2B importa contatos
