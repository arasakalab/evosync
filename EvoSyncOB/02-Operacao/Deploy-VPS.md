---
tipo: doc
tags: [evosync, operacao, deploy, vps]
criado: 2026-06-14
status: ativo
origem: evosync-web/docs/DEPLOY_VPS.md
---

# Deploy EvoSync em VPS (Ubuntu 24.04)

> Importado de `evosync-web/docs/DEPLOY_VPS.md`. Veja também [[Seguranca]] para o
> modelo de ameaças e boas práticas pós-deploy.
...
- [[Seguranca]] — modelo de ameaças, criptografia, boas práticas
- [[Visao-Geral]] — arquitetura
- [[MOC-SaaS-Web]] — mapa do app
